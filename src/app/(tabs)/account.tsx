  ...
  const executeDeleteAccount = async () => {
    ...
    try {
      ...
      await AsyncStorage.multiRemove([
        ...
        URGE_PREDICTION_SCHEDULE_KEY, URGE_PREDICTION_NOTIF_ID_KEY, AI_CHECKIN_NOTIF_ID_KEY,
