...
const s = StyleSheet.create({
  ...
  progressDone: { fontSize: 13, color: '#0a7a4e', fontWeight: '500', textAlign: 'center', paddingTop: 4 },
  ...
  itemDone: { backgroundColor: '#f8fdfd' },
  ...
  checkboxDone: { backgroundColor: '#0F6E6E', borderColor: '#0F6E6E' },
  itemText: { flex: 1, gap: 3 },
  itemTitle: { fontSize: 14, fontWeight: '600', color: '#111' },
  itemTitleDone: { color: '#0F6E6E', textDecorationLine: 'line-through' },
  itemDesc: { fontSize: 12, color: '#888', lineHeight: 17 },
});
